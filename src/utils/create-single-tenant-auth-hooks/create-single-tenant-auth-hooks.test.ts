import { createSingleTenantAuthHooks } from './create-single-tenant-auth-hooks';

const userRolesTable = 'user_roles';

describe('createSingleTenantAuthHooks', () => {
  it('should return SQL that creates or replaces a DB function to check user roles and org membership', () => {
    expect(createSingleTenantAuthHooks({ userRolesTable })).toBe(`CREATE
