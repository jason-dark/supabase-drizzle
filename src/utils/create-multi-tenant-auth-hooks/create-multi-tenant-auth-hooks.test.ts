import { createMultiTenantAuthHooks } from './create-multi-tenant-auth-hooks';

const userRolesTable = 'tenant_user_roles';

describe('createMultiTenantAuthHooks', () => {
  it('should return SQL that creates or replaces a DB function to check user roles and org membership', () => {
    expect(createMultiTenantAuthHooks({ userRolesTable })).toBe(`CREATE
